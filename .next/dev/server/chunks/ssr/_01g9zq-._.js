...
const metadata = {
    ...
    description: 'Professional photography services specializing in weddings, portraits, nature, and events. Based in Sri Lanka — booking worldwide.',
    keywords: 'photography, wedding photography, portrait photography, Sri Lanka photographer, professional photography',
    authors: [
        {
            name: 'Tharu Photography'
        }
    ],
    openGraph: {
